...
public class AdminPermissionPolicy {
    ...
    private String requiredPermission(String path) {
        ...
        if (adminPath.equals("/settings") || adminPath.startsWith("/settings/") ||
            adminPath.equals("/sms-login-settings") || adminPath.startsWith("/sms-login-settings/") ||
            adminPath.equals("/captcha-settings") || adminPath.startsWith("/captcha-settings/") ||
            adminPath.equals("/payment-channels") || adminPath.startsWith("/payment-channels/")) {
            return "settings:manage";
        }
        if (adminPath.equals("/staff") || adminPath.startsWith("/staff/")) {
            return "staff:manage";
        }
