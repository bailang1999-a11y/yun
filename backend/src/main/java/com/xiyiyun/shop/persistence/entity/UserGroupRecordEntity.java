...
public class UserGroupRecordEntity {
    ...
    private String priceLimitNotice;
    ...
    public Boolean getPriceLimitEnabled() { return priceLimitEnabled; }
    public void setPriceLimitEnabled(Boolean priceLimitEnabled) { this.priceLimitEnabled = priceLimitEnabled; }
    public String getPriceLimitNotice() { return priceLimitNotice; }
    public void setPriceLimitNotice(String priceLimitNotice) { this.priceLimitNotice = priceLimitNotice; }
}
