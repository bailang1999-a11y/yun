...
public class OrderRecordEntity {
    ...
    private String orderIpLocation;
    ...
    public String getOrderIpLocation() {
        return orderIpLocation;
    }

    public void setOrderIpLocation(String orderIpLocation) {
        this.orderIpLocation = orderIpLocation;
    }
    ...
    public void setChannelAttemptsJson(String channelAttemptsJson) {
        this.channelAttemptsJson = channelAttemptsJson;
    }
