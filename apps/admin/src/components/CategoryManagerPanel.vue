...
.category-canvas {
  ...
  height: auto;
  background:
    radial-gradient(circle at 12% 8%, rgba(0, 255, 195, 0.16), transparent 34%),
    radial-gradient(circle at 88% 0%, rgba(58, 165, 255, 0.18), transparent 32%),
    linear-gradient(135deg, rgba(5, 18, 34, 0.92), rgba(8, 37, 62, 0.76));
  border: 0.5px solid rgba(86, 211, 255, 0.2);
  box-shadow:
...
.catalog-content {
  ...
  background:
    ...
    linear-gradient(90deg, rgba(0, 255, 195, 0.035), rgba(58, 165, 255, 0.035));
}
...
.category-breadcrumb em {
  ...
  font-style: normal;
  border-left: 0.5px solid rgba(122, 204, 255, 0.2);
}
...
.category-level + .category-level {
  margin-top: 18px;
  padding-top: 18px;
  border-top: 0.5px solid rgba(122, 204, 255, 0.16);
}
...
.category-icon-card.add-card {
  border-color: rgba(122, 204, 255, 0.22);
  background:
    linear-gradient(135deg, rgba(0, 255, 195, 0.1), rgba(58, 165, 255, 0.08)),
    rgba(4, 19, 32, 0.32);
}
